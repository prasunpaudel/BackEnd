<x-layout bodyClass="g-sidenav-show bg-gray-200">
    ...
    <x-navbars.sidebar activePage="editProduct"></x-navbars.sidebar>
    <div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage='editProduct'></x-navbars.navs.auth>
        <!-- End Navbar -->
                        ...
                        <form method='POST' action="{{ route('posteditproduct',$product->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" name="title"  value="{{$product ->title }}" class="form-control border border-2 p-2" ></input>
                                    @error('title')
                                    <p class='text-danger inputerror'>{{ $message }} </p>
                                    @enderror
                                </div>
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="number" name="cost"  value="{{$product ->cost }}" class="form-control border border-2 p-2"></input>
                                    @error('cost')
                                    <p class='text-danger inputerror'>{{ $message }} </p>
                                    @enderror
                                ...
                                <div class="mb-3 col-md-6">
                                        ...
                                        <input type="file" name="image" class="form-control border border-2 p-2" > 
                                           <img src="/site/uploads/AddProduct/{{$product->photo}}"
