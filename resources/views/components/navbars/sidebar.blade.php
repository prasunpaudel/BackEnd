...
<aside
    ...
    <div class="w-auto  max-height-vh-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'catagory' ? ' active bg-gradient-primary' : '' }} "
                    href="{{ route('catagory') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'managecatagory' ? ' active bg-gradient-primary' : '' }} "
                    href="{{ route('getmanagecatagory') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">table_view</i>
                    </div>
                    <span class="nav-link-text ms-1">managecatagory</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'socialmedia' ? ' active bg-gradient-primary' : '' }} "
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'ManageSocialMedia' ? ' active bg-gradient-primary' : '' }} "
                    href="{{ route('getmanagesocialmedia') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">table_view</i>
                    </div>
                    <span class="nav-link-text ms-1">ManageSocialMedia</span>
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'ManageGallery' ? ' active bg-gradient-primary' : '' }} "
                    ...
                    <span class="nav-link-text ms-1">ManageGallery</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'AddProduct' ? ' active bg-gradient-primary' : '' }} "
                    ...
                    <span class="nav-link-text ms-1">AddProduct</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'manageproduct' ? ' active bg-gradient-primary' : '' }} "
                    ...
                    <span class="nav-link-text ms-1">ManageProduct</span>
                </a>
            </li>
            <li class="nav-item">
